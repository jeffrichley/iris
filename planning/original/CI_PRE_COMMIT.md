Here is the detailed **CI & Pre-commit Strategy** document for your AI agent. It’s written with _specific versions, actions, tools, and workflows_ (no “or” options) to achieve world-class quality.
